...
function LeadershipProfile({ onSignOut }) {
  const handleSignOut = () => {
      ...
      <div className="employee-profile-main">
        ...
        <div className="employee-profile-card">
          <div className="employee-profile-left">
            {/* No profile photo until real profile data (including a photo) is
                loaded from Supabase. Empty div preserves the placeholder box shape. */}
