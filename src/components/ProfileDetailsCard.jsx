...
function ProfileDetailsCard({ profileData, showSupervisor = false, showHrPartner = false }) {
  return (
    <div className="employee-profile-card">
      <div className="employee-profile-left">
        ...
        <div className="employee-profile-pill">{profileData.department || "Unassigned team"}</div>
